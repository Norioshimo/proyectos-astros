import { A as AstroError, f as ActionNotFoundError } from './astro/assets-service_4BCN_0xJ.mjs';
...
async function getAction(path) {
  ...
  let { server: actionLookup } = await import('./_astro_internal-actions_oytMX_M3.mjs');
